  ...
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="home.php">
        <img style="width:14vw; height:7vh; padding-top:0px;" alt="Brand" src="asset/img/5.jpg">
      </a>
    </div>
...
<div class="container-fluid kategori">
  <div class="row">
    <div class="col-xs-2 col-xs-offset-2">
        <a href="home.php"><img style="width:8vw; height:10vh; padding-top:1vh;" alt="Brand" src="asset/img/1.jpg"></a>
    </div>
    <div class="col-xs-6">
      <ul class="nav nav-pills kategori2">
        </li>
		<li><a data-toggle="pill" href="#special">Special</a></li>
		<li><a data-toggle="pill" href="#mozzarella">Mozzarella</a></li>
        <li><a data-toggle="pill" href="#provolone">Provolone</a></li>
        <li><a data-toggle="pill" href="#camembert" >Camembert</a></li>
        <li><a data-toggle="pill" href="#ricotta">Ricotta</a></li>
      </ul>
    </div>
  </div>
</div>
