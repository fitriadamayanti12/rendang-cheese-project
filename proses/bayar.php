<?php 
  ...
  if($query){
    echo '
      <script>
      alert("Terima Kasih sudah Berbelanja, Silahkan Tranfer ke Rekening Mandiri 140-0-0-165473-4 an. Fitria Damayanti. Barang anda akan segera kami kirim setelah pembayaran dilakukan. Terima kasih");
